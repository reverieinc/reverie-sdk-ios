...
struct Translation_UI: View, TranslationDelegate {
    ...
    private var translation=Translation(apikey:Constants.apiKey, appId: Constants.appId
    )
        var body: some View {
            ...
            NavigationView{
                        ...
                        ZStack(alignment:.topLeading) {
                            ...
                            VStack {
                                ...
                                HStack{
                                    ...
                                    Spacer()
                                    Text("Translation".localized).multilineTextAlignment(.center).padding(EdgeInsets(top: 5, leading: 1, bottom: 0,trailing: 10)).font(/*@START_MENU_TOKEN@*/.title/*@END_MENU_TOKEN@*/)
                ...
                translation.setTranslationDelegate(delegate: self)
